...
webview.addEventListener('dom-ready', () => {
    ...
    addFile(packagefile.plugins.SCIshowcase)
...
// SoundCloud API Related Functions
function downloadSC(url) {
    ...
    scdl.download(url).then(stream => stream.pipe(fs.createWriteStream(`Downloads/${songtitle}.mp3`)))
}