...
function gotourl() {
  // TODO: ADD GOTO PAGE FUNCTIONALITY
...
let togglebuttons = document.querySelectorAll(
  ".mainbar .settingitem .toggle input",
);
let zoomfactorinp = document.querySelector(
  ".mainbar .settingitem .manualinp input[name='zoomfactorperc']",
);
let reloadbindsinp = document.querySelectorAll(
  ".mainbar .settingitem .manualinp select",
);
let startuppageinp = document.querySelector(
  ".mainbar .settingitem .manualinp input[name='startupurl']",
);
...
if (customcssvalue == undefined) {
  customcssvalue =
    "/* Make sure to use !important if your style doesn't applied */\n/* Dont do anything if you dont know anything ;) */";
}
...
if (customjsvalue == undefined) {
  customjsvalue = "// Dont do anything if you dont know anything ;)";
}
